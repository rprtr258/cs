...
func TestRemoveStringDuplicates(t *testing.T) {
	r := []string{"test", "test"}
	if len(slices.Collect(RemoveStringDuplicates(slices.Values(r)))) != 1 {
		t.Error("Expected a single return")
	}
}

func TestPermuteCase(t *testing.T) {
	permutations := slices.Collect(PermuteCase("fo"))
...
func TestPermuteCaseUnicode(t *testing.T) {
	permutations := slices.Collect(PermuteCase("ȺȾ"))
	if len(permutations) != 4 {
		t.Error("Expected 4 returns")
	}
}
...
func TestPermuteCaseUnicodeNoFolding(t *testing.T) {
	permutations := slices.Collect(PermuteCase("ſ"))
...
func TestAllSimpleFoldAsciiNumber(t *testing.T) {
	folded := slices.Collect(AllSimpleFold('1'))
	if len(folded) != 1 {
...
func TestAllSimpleFoldAsciiLetter(t *testing.T) {
	folded := slices.Collect(AllSimpleFold('z'))
	if len(folded) != 2 {
...
func TestAllSimpleFoldMultipleReturn(t *testing.T) {
	folded := slices.Collect(AllSimpleFold('ſ'))
	if len(folded) != 3 {
...
func TestAllSimpleFoldNotFullFold(t *testing.T) {
	...
	folded := slices.Collect(AllSimpleFold('ß'))
	if len(folded) != 2 {
		t.Error("Should get 2 results")
	}
}
...
func TestPermuteCaseFoldingUnicodeNoFolding(t *testing.T) {
	permutations := slices.Collect(PermuteCaseFolding("ſ"))
...
func TestPermuteCaseFolding(t *testing.T) {
	folded := slices.Collect(PermuteCaseFolding("nſ"))
	if len(folded) != 6 {
...
func TestPermuteCaseFoldingNumbers(t *testing.T) {
	folded := slices.Collect(PermuteCaseFolding("07123E1"))
	if len(folded) != 2 {
...
func TestPermuteCaseFoldingComparison(t *testing.T) {
	r1 := slices.Collect(PermuteCase("groß"))
	r2 := slices.Collect(PermuteCaseFolding("groß"))
	if len(r1) >= len(r2) {
